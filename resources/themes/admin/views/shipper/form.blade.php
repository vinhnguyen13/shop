...
@section('content-header')
    @include('layouts._partials.content-header', ['data'=>['h1'=>'Shipper', 'h1_href'=>route('admin.shipper.index'), 'h1_small'=>$isNewRecord ? 'Create' : 'Edit']])
@endsection

@section('content')
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><?php echo $isNewRecord ? "Create" : "Edit"?> Shipper</h3>
        </div>
        <div class="box-body">
            {{ Form::open(['route' => 'admin.shipper.store', 'files' => true]) }}
