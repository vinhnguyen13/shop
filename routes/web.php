...
Route::group(['middleware' => ['web'], 'module' => 'Frontend', 'namespace' => 'App\Http\Controllers\Frontend'], function () use ($locale, $langs) {
    ...
    Route::post('/product/customers', ['uses' => 'ProductController@loadCustomers'])->name('product.loadCustomers');
    Route::post('/product/customer', ['uses' => 'ProductController@loadCustomer'])->name('product.loadCustomer');
    /*
     * Location
     */
