<?php 
  ...
  class MobiCard{
    ...
    function CardPay($pin_card,$card_serial,$type_card,$_order_id,$client_fullname,$client_mobile,$client_email){
		 $params = array(
				'func'					=> ConfigNL::$_FUNCTION,
				'version'				=> ConfigNL::$_VERSION,
				'merchant_id'			=> ConfigNL::$_MERCHANT_ID,
				'merchant_account'		=> ConfigNL::$_EMAIL_RECEIVE_MONEY,
				'merchant_password'		=> MD5(ConfigNL::$_MERCHANT_ID.'|'.ConfigNL::$_MERCHANT_PASSWORD),
				'pin_card'				=> $pin_card,
